...
df_gci35= pd.read_csv(ROOT+"/data/test/gci_0.35.csv",header=0,index_col=0)
df_gci40= pd.read_csv(ROOT+"/data/test/gci_0.4.csv",header=0,index_col=0)
df_gci45= pd.read_csv(ROOT+"/data/test/gci_0.45.csv",header=0,index_col=0)
df_gci= pd.read_csv(ROOT+"/data/test/gci_0.5.csv",header=0,index_col=0)
